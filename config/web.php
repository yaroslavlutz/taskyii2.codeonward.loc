...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => '4COAhShNXKyNIrDY2vAIWa0YMjEPHN3w',
        ],
        'cache' => [
        ...
        'mailer' => [
            ...
            'useFileTransport' => true, //если значение этого свойства true,- то все письма будут сохраняться в директорию runtime/mail
        ],
        'log' => [
